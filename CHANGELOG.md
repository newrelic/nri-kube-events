...
### ⛓️ Dependencies
- Updated github.com/prometheus/client_model to v0.6.3 - [Changelog 🔗](https://github.com/prometheus/client_model/releases/tag/v0.6.3)
...
### 🚀 Enhancements
- Add support for Kubernetes 1.35, remove support for 1.30 @jamescripter [#569](https://github.com/newrelic/nri-kube-events/pull/569)
...
### dependency
- Updating Common library to 2.3.1 @philip-r-beckwith (#561)[[https://github.com/newrelic/nri-kube-events/pull/561](https://github.com/newrelic/nri-kube-events/pull/561)\]
...
- Updated archive/github-actions-slack to v3
...
- Implement global.images.pullPolicy inheritance in compatibility helpers with tests @TmNguyen12 [#516](https://github.com/newrelic/nri-kube-events/pull/516)
